...
/**
 */
class S_Sitemaps_Handler_Ajax_NewsTermsHandler extends S_Sitemaps_Handler_AjaxHandler
{
	protected $provider;
	...
	public function __construct(
		S_Sitemaps_Provider_Taxonomy $provider,
		array $news_terms,
		array $news_genres
	) {
	...
	public function get_term_genres_action()
	{
		...
		if ($taxonomy = S_Framework_Util::get_request_var('news_taxonomy')) {
