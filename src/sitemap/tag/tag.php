 ...
 */
abstract class S_Sitemaps_Sitemap_Tag
{
	/**
	 ...
	 * Parent of this tag
	 *
	 * @var S_Sitemaps_Sitemap_Tag_CompoundTag
	 */
	protected $parent;
	 ...
	 *
	 * @var S_Sitemaps_Sitemap_Sanitizer[]
	 */
	 ...
	 * @param mixed S_Sitemaps_Sitemap_Sanitizer|array S_Sitemaps_Sitemap_Sanitizer[]
	 */
	public static function create_single_tag($name, $value = null, $sanitizers = null)
	{
		$tag = new S_Sitemaps_Sitemap_Tag_SingleTag($name);
		...
		$tag->add_sanitizer(new S_Sitemaps_Sitemap_Sanitizer_Xml_TextSanitizer());
	...
	{
		return new S_Sitemaps_Sitemap_Tag_CompoundTag($name);
	}
	 ...
	 *
	 * @param S_Sitemaps_Sitemap_Tag_CompoundTag $tag
	 */
	public function set_parent(S_Sitemaps_Sitemap_Tag_CompoundTag $tag)
	{
		$this->parent = $tag;
	}
	 ...
	 *
	 * @param S_Sitemaps_Sitemap_Sanitizer $sanitizer
	 */
	public function add_sanitizer(S_Sitemaps_Sitemap_Sanitizer $sanitizer)
	{
