 ...
 */
class S_Sitemaps_Sitemap_XmlGoogleNews extends S_Sitemaps_Sitemap_Xml
{
	protected $news_name;
	...
	protected function get_xml_item_body(array $item)
	{
		...
		$location = S_Sitemaps_Sitemap_Tag::create_single_tag('loc', $item['location']);
		$news = S_Sitemaps_Sitemap_Tag::create_compound_tag('news:news');
		$news_publication = S_Sitemaps_Sitemap_Tag::create_compound_tag('news:publication');
