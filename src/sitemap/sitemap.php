 ...
 */
abstract class S_Sitemaps_Sitemap
{
	/**
	 * Sitemap item provider
	 *
	 * @var S_Sitemaps_Sitemap_Provider
	 */
	protected $provider;
	 ...
	 *
	 * @var S_Sitemaps_Sitemap_Sanitizer_Factory
	 */
	...
	public function __construct(
		S_Sitemaps_Sitemap_Provider $provider,
		S_Sitemaps_Sitemap_Sanitizer_Factory $sanitizer_factory,
		$stylesheet = null
	) {
