 ...
 *
 */
abstract class S_Sitemaps_Logger
{
	/**
	 * Log items
	 *
	 ...
	 * @return S_Sitemaps_Logger_MessageLogger
	 */
	public static function create_message_logger($limit = 0)
	{
		$logger = new S_Sitemaps_Logger_MessageLogger();
	 ...
	 * @return S_Sitemaps_Logger_SitemapLogger
	 */
	public static function create_sitemap_logger($limit = 0)
	{
		$logger = new S_Sitemaps_Logger_SitemapLogger();
		$logger->set_limit($limit);
	 ...
	 * Log an item
	 *
	 * @param S_Sitemaps_Logger_LogItem $item
	 */
	 ...
	 * @return false
	 */
	public function filter_items(S_Sitemaps_Logger_LogItem $item)
	{
		// if this item can become obsolete, so they should be filtered out if
		// they are obsolete
		if ($item instanceof S_Sitemaps_Logger_Sitemap_LogItem && $item->is_obsolete()) {
			return false;
		}
	...
	/**
	 * @return S_Sitemaps_Logger_LogItem[] array of S_Sitemaps_Logger_LogItem
	 */
	...
	public function get_log_item_data()
	{
		...
		/* @var $item S_Sitemaps_Logger_LogItem */
