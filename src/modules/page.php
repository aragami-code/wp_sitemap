...
class S_MB_MODULE_PAGE extends S_MB_MODULE_POST
{
	...
	protected function generate_data()
	{
		...
		$excluded_posts   = apply_filters('s_mb_excluded_posts', array(), 'page');
		...
		$sql_where = apply_filters('s_mb_post_where', '', 'page');
