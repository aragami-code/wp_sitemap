...
class S_MB_MODULE_POST extends S_MB_MODULE
{
	public function __construct()
	{
		...
		// you must name your class f_GXS_MODULE_TAXONOMY_CATEGORY and save
		...
		// our SQL query accordingly - @since f GXS 1.1.0
		// @since 1.3.0 this is set in main class
		/* $this->part = $f_gxs->module_data['module_part']; */
	...
	protected function generate_data()
	{
		 ...
		 *
		 * @example hooks/filter_fff_gxs_excluded_posts.php 2
		 *
		 ...
		 */
		$excluded_posts = apply_filters('s_mb_excluded_posts', array(), $requested);
		...
		// their ids
		$excluded_term_ids = apply_filters('s_mb_excluded_terms', array(), null, true);
		if ($s_mb->options['enable_exclude_posts_by_terms'] == 'yes'
		 ...
		 *
		 * @example hooks/filter_f_gxs_post_where.php 2
		 *
		 ...
		 */
		$sql_where = apply_filters('s_mb_post_where', '', $requested);
