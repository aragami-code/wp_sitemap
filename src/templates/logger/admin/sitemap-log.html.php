...
<!--[if lte IE 9]>
<div class="s-table-fixed-headers-old-id-wrapper" style="width: 700px">
<!--<![endif]-->
	<table class="wp-list-table widefat striped s-table s-table-md s-table-inline s-table-fixed-headers s-table-valign-middle" style="width: 700px;">
		<thead>
			<tr>
				<th class="ordinal">#</th>
			...
			<tr>
				...
				<td style="width: 200px">
					<a target="_blank" title="<?php _e('Click to view', $this->domain); ?>"
						...
						class="button-secondary s-button">
