	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div id="footer">
					Generated with <a href="https://bestwebsoft.com/products/wordpress/plugins/google-sitemap/">Google Sitemap</a> plugin by <a href="https://magebazard.com">Mage Bazard</a>
				</div>
			</body>
		</html>
	</xsl:template>
