...
class S_Framework_Util
{
	...
	{
		if (defined('S_SUBDOMAIN_INSTALL'))
			return S_SUBDOMAIN_INSTALL;
	...
	public static function is_admin_user()
	{
		...
		if (defined('S_IS_ADMIN_USER'))
			return S_IS_ADMIN_USER;
	...
	public static function is_super_admin()
	{
		...
		if (defined('S_IS_SUPER_ADMIN'))
			return S_IS_SUPER_ADMIN;
