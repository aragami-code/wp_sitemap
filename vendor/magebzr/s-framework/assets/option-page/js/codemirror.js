...
var s_editors = (function($, cm) {
	...
	$(function() {
		...
		$('body').on('click', '.s-button-code-editor', function(e) {
			e.preventDefault();
		...
		$('.s-code-editor').each(function(i, node) {
			init_editor(node);
		});

		// allow toggling the code editor's readonly attribute
		$('body').on('change', '.s-code-editor-cb', toggle_edit);
		$('.s-code-editor-cb').each(function() {
